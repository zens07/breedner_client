                            ...
                            <Col lg={12} md={12} sm={12} xs={12} className="bg-white text-dark p-0">
                                <Row className="m-0 px-1">
                                    ...
                                    <Col lg={10} md={10} sm={10} xs={10} className="p-0">
                                        <input type="text" id="disabledTextInput" className="form-control-plaintext text-right p-0" placeholder="zezen07@gmail.com" disabled />
                                    </Col>
                                </Row>
                                <hr />
                                <Row className="m-0 px-1">
                                    ...
                                    <Col lg={10} md={10} sm={10} xs={10} className="p-0">
                                        <input type="text" id="disabledTextInput" className="form-control-plaintext text-right p-0" placeholder="081772891204" disabled />
                                    </Col>
                                </Row>
                            </Col>
                            <Col lg={12} md={12} sm={12} xs={12} className="font-gradient1 p-3">
